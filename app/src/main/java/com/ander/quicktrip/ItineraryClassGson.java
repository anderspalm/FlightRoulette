...
//         IN Itinerary = gson.fromJson(response.toString(), ItineraryClassGson.class);
    ...
    public void setItineraries(List<ItineraryObjectsClass> itineraries) {
        Itineraries = itineraries;
    }

    public List<ItineraryObjectsClass> getItineraries() {
        return Itineraries;
    }
...
//            private FlightReturnClass InboundLegId;
        ...
        public BookingDetailsClass getBookingDetailsLink() {
